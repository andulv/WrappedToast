const toastuiStyles = '<style>'
    ...
    + 'h1{font-size:24px;font-weight:700;color:#222;border-bottom:3px double #999;padding-bottom:7px;margin:14px 0 15px}'
    + 'h2{font-size:22px;font-weight:700;color:#222;border-bottom:1px solid #dbdbdb;padding-bottom:7px;margin:20px 0 13px}'
    + 'h3{font-size:20px;font-weight:700;color:#222;margin:18px 0 2px}'
    ...
    + 'ol,ul{margin:6px 0 10px;padding-left:24px}'
